...
?>
<table class="em-calendar fullcalendar" style ='width:100%'>
    <thead>
        <tr>
            <td><center><a class="em-calnav full-link em-calnav-prev" href="<?php echo $calendar['links']['previous_url']; ?>">&lt;&lt;</a></center></td>
<td class="month_name" colspan="5" style ='padding-top:10px;padding-bottom: 10px'><h2><center><?php echo ucfirst(date_i18n(get_option('dbem_full_calendar_month_format'), $calendar['month_start'])); ?></h2></center></td>
<td><center><a class="em-calnav full-link em-calnav-next" href="<?php echo $calendar['links']['next_url']; ?>">&gt;&gt;</a></center></td>
            </tr>
    </thead>
    <tbody>
        <tr class="days-names">
            <td style ='width:14%'><?php echo implode("</td><td style = 'width:14%'>", $calendar['row_headers']); ?></td>
        </tr>
        <tr>
            <?php
