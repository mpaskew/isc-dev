<?php
/*
Template Name: Blog - Event Recap Filter
*/
?>
<?php get_header(); ?>
...
<section class="wrap">
	...
	<div class="row">
		...
		<div class="twelve columns nav-page clearfix">
			<ul class="nav-page-filter left h-list">
				<li><a href="/news">Everything</a></li>
				<li><a href="/blog/news">News</a></li>
				<li><a href="/blog/event-recaps" class="active">Event Recaps</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="blog-list-landing row">
	    ...
	    <?php endwhile;// posts ?>
	    <div class="row">
	    	<div class="pagination twelve columns"><a href="" class="font-ext right">view more posts &gt;</a></div>
	    </div>
